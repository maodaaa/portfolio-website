  ...
  return (
    <header className='lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-1/2 lg:flex-col lg:justify-between lg:py-24 flex flex-col lg:gap-4'>
      <div className='flex flex-col gap-4 lg:pr-24 mt-6 lg:mt-0'>
        ...
        <h1 className='text-4xl lg:text-start font-bold tracking-tight text-slate-200 sm:text-5xl'>
          Maorid Manarul Hidayat
        </h1>
        <h2 className='text-lg font-medium tracking-tight text-primary sm:text-xl lg:text-start'>
          <Typewriter
            options={{
              strings: [
                'Android Developer.',
        ...
        <p className='text-lg lg:text-start text-muted-foreground'>
          I build intuitive mobile apps that prioritize user experience,
          seamlessly merging tech and design to connect people effortlessly.
        </p>
      </div>
      ...
      <ul className='flex flex-row gap-6 mt-6 lg:mt-0'>
        ...
        <Button variant='outline' size='icon'>
          <a
            href='https://www.linkedin.com/in/maorid-manarul-hidayat/'
            target='_blank'
            rel='noopener noreferrer'
          >
